...
// Constants :
static const CGFloat kFontSize = 5;
static const NSInteger kStarWidthAndHeight = 50;
...
{
    NSLog(@"_rating:%ld", _rating);
    NSLog(@"_maxRating:%ld", _maxRating);
